...
- The weekly worksheets: the printed handout text was read for what to hand in, and the inked handout pages for weeks 1 to 4 and 6 were read as page images for how a completed worksheet is laid out (recorded as observed practice, not a requirement). No problem content or values are recorded.
